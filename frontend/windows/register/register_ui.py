...
"}")
    ...
    def retranslateUi(self, Register):
        ...
        self.passwordRequirementsLabel.setText(QCoreApplication.translate("Register", u"Password must be 20 characters with one uppercase, lowercase and special character", None))
