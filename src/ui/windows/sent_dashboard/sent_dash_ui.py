...
################################################################################
## Form generated from reading UI file 'sent_dash.ui'
##
...
class Ui_Sent(object):
    def setupUi(self, Sent):
        if not Sent.objectName():
...
"}")
        ...
        self.receivedButton1 = QPushButton(self.navBar)
        self.receivedButton1.setObjectName(u"receivedButton1")
        self.receivedButton1.setMinimumSize(QSize(0, 42))
        self.receivedButton1.setStyleSheet(u"QPushButton {\n"
"  font-size: 14px;\n"
"  font-weight: 500;\n"
"  color: white;\n"
...
"}")
        ...
        self.navBarLayout.addWidget(self.receivedButton1)
...
"}")
        ...
        self.fileList = QListWidget(Sent)
...
"}")
        ...
        self.sendButton = QPushButton(Sent)
...
"}")
        ...
        self.retranslateUi(Sent)

        QMetaObject.connectSlotsByName(Sent)
    # setupUi

    def retranslateUi(self, Sent):
        Sent.setWindowTitle(QCoreApplication.translate("Sent", u"Nightwood - Sent Files", None))
        self.logoLabel.setText("")
        self.logoTextLabel.setText(QCoreApplication.translate("Sent", u"Nightwood", None))
        self.receivedButton.setText(QCoreApplication.translate("Sent", u"Received Files", None))
        self.receivedButton1.setText(QCoreApplication.translate("Sent", u"Sent Files", None))
        self.sendFileButton.setText(QCoreApplication.translate("Sent", u"Send File", None))
        self.settingsButton.setText(QCoreApplication.translate("Sent", u"Settings", None))
        self.pageTitle.setText(QCoreApplication.translate("Sent", u"Sent Files", None))
        self.sendButton.setText(QCoreApplication.translate("Sent", u"Send File", None))
    # retranslateUi
