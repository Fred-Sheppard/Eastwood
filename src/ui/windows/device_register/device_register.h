...
public:
    explicit DeviceRegister(const std::string& auth_code, const QImage& qr_code, QWidget *parent = nullptr, unsigned char* pk_device = nullptr, const std::string& username = "");
